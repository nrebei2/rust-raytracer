...
pub fn get_color(pixel_color: Color, sample_per_pixels: i32) -> Vec<u8> {
    let mut r = pixel_color.x();
    let mut g = pixel_color.y();
    let mut b = pixel_color.z();
    ...
    vec![(256. * f64::clamp(r, 0.0, 0.999)) as u8,
    (256. * f64::clamp(g, 0.0, 0.999)) as u8,
    (256. * f64::clamp(b, 0.0, 0.999)) as u8]
